...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <form role="form" class="form-horizontal" action="mecha.php" method="post">
                        ...
                        <div class="col-xs-5">
                            <select id="carrera" name="carrera" class="form-control" onchange="validacion('carrera');">
                                ...
                                <option value="3">Ing. Pesquera</option>
                                    ...
                                    <div class="form-group">
                    <label for="inicial" class="control-label col-xs-3">Abscisa inicial:</label>
                    <div class="col-xs-9">
                        <input id="inicial" name="inicial" type="text" class="form-control" placeholder="Abscisa inicial" onkeyup="sumar();
                                validacion('inicial');">
                        <span class="help-block"></span>
                    </div>
                </div>
                                <div class="form-group">
                    <label for="final" class="control-label col-xs-3">Abscisa final:</label>
                    <div class="col-xs-9">
                        <input id="final" name="final" type="text" class="form-control" placeholder="Abscisa final" onkeyup="sumar();
                                validacion('final');">
                        <span class="help-block"></span>
                    </div>
                </div>
...
jQuery(function($){
   ...
   $("#inicial").mask("K 9-999,99 a");
   $("#final").mask("K 9-999,99 a");
   $("#total").mask("K 9-999,99 a");
   $("#").mask("999-99-9999");
});
</script>
