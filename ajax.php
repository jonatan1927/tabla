...
if (isset($_POST["ajax"]))
{
    ...
    {
        $mensaje = "<script>document.getElementById('e_nombre').innerHTML='Error, formato de email incorrecto';</script>";
    }
    else if(strlen($email) < 8)
    {
        $mensaje = "<script>document.getElementById('e_nombre').innerHTML='El m&iacute;nimo permitido 8 caracteres';</script>";
    }
    ...
    {
        $mensaje = "<script>document.getElementById('e_nombre').innerHTML='Obligatorio, letras y n&uacute;meros';</script>";
    }
